...
<body>
    ...
    <div id="flowModal">
        <div class="flow-modal-box">
            ...
            <div class="flow-modal-body">
                ...
                <!-- =========================================================
                     KOMENTAR / PESAN TIM & USER
                     ========================================================= -->
                <div class="comments-section">
                    <div class="comments-header">
                        <h4><i class="fas fa-comments" style="color: #0284c7;"></i> Catatan & Komentar Pengguna / Tim SMTI</h4>
                        <small style="color: #64748b;" id="comments-count-badge">0 Komentar</small>
                    </div>
                    ...
                    <form class="comment-form" onsubmit="event.preventDefault(); addNewComment();">
                        <input type="text" id="new-comment-input" class="comment-input" placeholder="Tulis catatan, instruksi, atau update progres untuk user lain...">
    ...
    <script>
        ...
        /* =========================================================
           KOMENTAR & CATATAN TIM SMTI / USER
           ========================================================= */
        function renderComments(project) {
            ...
            countBadge.innerText = `${project.comments.length} Catatan`;

            if (project.comments.length === 0) {
                list.innerHTML = `
                    <div style="padding: 16px; text-align: center; color: #94a3b8; font-size: 12px;">
                        <i class="fas fa-comment-dots" style="font-size: 20px; margin-bottom: 6px; display: block;"></i>
                        Belum ada pesan/komentar dari tim. Tulis pesan pertama Anda di bawah.
                    </div>
                `;
                return;
            }
                ...
                <div class="comment-item">
                    <div class="comment-top">
                        <span class="comment-author-badge">
                            <i class="fas fa-user-circle"></i> ${c.author} <small style="color: #64748b;">(${c.role})</small>
                        </span>
                        <div style="display: flex; align-items: center; gap: 8px;">
                            <span class="comment-time"><i class="fas fa-clock"></i> ${c.time}</span>
                            <button class="task-delete-btn" onclick="deleteComment(${c.id})" title="Hapus catatan ini">
